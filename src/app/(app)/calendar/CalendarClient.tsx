...
const STATUS_COLORS: Record<string,string> = {
  wishlist:"#a1a1aa", applied:"#93c5fd", phone_screen:"#fbbf24",
  interview:"#c4b5fd", offer:"#34d399", rejected:"#f87171", withdrawn:"#fb923c", ghosted:"#94a3b8"
}
      ...
      <div className="flex gap-6 flex-wrap lg:flex-nowrap">
        ...
        <div className="flex-1 min-w-0">
                ...
                <div key={i} className={`cal-day ${isToday ? "today" : ""} ${!cell.isCurrentMonth ? "other-month" : ""}`}>
                  ...
                  {events.slice(0, 3).map((ev, j) => (
                    <div key={j} className="cal-event" onClick={() => router.push("/applications/" + ev.app.id)}
                      style={{ background: ev.type === "deadline" ? "rgba(239,68,68,0.15)" : ev.type === "follow_up" ? "rgba(245,158,11,0.15)" : "rgba(59,130,246,0.1)", color: ev.type === "deadline" ? "#f87171" : ev.type === "follow_up" ? "#f59e0b" : "#93c5fd" }}
          ...
          <div className="flex items-center gap-5 mt-4 flex-wrap">
            {[["rgba(59,130,246,0.15)","#93c5fd","Applied"],["rgba(245,158,11,0.15)","#f59e0b","Follow-up"],["rgba(239,68,68,0.15)","#f87171","Deadline"]].map(([bg,color,label]) => (
          ...
          {upcoming.length === 0 ? (
            ...
            <div className="space-y-2">
              {upcoming.map(app => {
                ...
                return (
                  <div key={app.id} className="rounded-lg px-4 py-3 cursor-pointer transition-colors"
                    ...
                    <p className="text-xs mt-1 font-medium" style={{ color: daysLeft <= 3 ? "#f87171" : daysLeft <= 7 ? "#f59e0b" : "var(--muted)" }}>
