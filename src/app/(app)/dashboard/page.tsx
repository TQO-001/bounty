...
export default async function DashboardPage() {
  ...
  return (
    <div className="px-8 py-8 max-w-5xl">
      {/* We use a standard <style> tag with the 'jsx' attribute or global CSS 
        to handle the hover effect. This allows the component to remain 
        a Server Component because no functions are passed to the client.
      */}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {cards.map(c => (
          <Link 
            key={c.label} 
            href={c.href} 
            className="dashboard-card rounded-xl p-5 block transition-all"
            style={{ 
