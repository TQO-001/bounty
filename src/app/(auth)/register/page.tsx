...
export default function RegisterPage() {
  ...
  return (
    <div className="clay-lg p-8" style={{ background: "var(--surface)" }}>
      <h1 className="text-xl font-bold mb-6" style={{ color: "var(--text)" }}>Create account</h1>
      ...
      <form onSubmit={submit} className="space-y-4">
        {([["Full name","name","text"],["Email","email","email"],["Password","password","password"]] as [string,string,string][]).map(([l,k,t]) => (
          <div key={k}>
