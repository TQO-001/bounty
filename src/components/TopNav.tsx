    ...
    <>
      <nav className="topnav px-6 gap-4">
        ...
        <Link href="/dashboard" className="flex items-center gap-2.5 flex-shrink-0 mr-3">
          <div className="w-8 h-8 rounded-xl flex items-center justify-center text-black font-bold text-sm clay-sm"
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <button className="w-8 h-8 flex items-center justify-center rounded-xl hide-mobile"
            style={{ color: "var(--muted-2)" }}>
            <Bell size={16} />
          </button>
          ...
          <div className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 z-50 py-1 clay"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative w-64 h-full flex flex-col py-4 px-3 space-y-1 clay-lg"
            style={{ background: "var(--surface)" }}>
            <div className="flex items-center justify-between px-3 pb-3 mb-1"
              style={{ borderBottom: "1px solid var(--border)" }}>
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 rounded-xl flex items-center justify-center text-black font-bold text-sm clay-sm"
                  style={{ background: "var(--amber)" }}>B</div>
